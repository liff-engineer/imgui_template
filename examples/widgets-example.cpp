...
ImFont* gChineseFont = nullptr;
void MyLoadFonts()
{
    //作为默认字体
    gChineseFont = HelloImGui::LoadFontTTF_WithFontAwesomeIcons("fonts/LXGWBright-Regular.ttf", 18.0f, true);
...
int main(int, char* []) {
    ...
    params.appWindowParams.windowTitle = u8"示例 imgui-node-editor/examples/widgets-example";
